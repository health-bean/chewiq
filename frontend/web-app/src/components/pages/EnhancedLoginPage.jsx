// File: frontend/web-app/src/components/pages/EnhancedLoginPage.jsx
// Simplified login page with AWS Amplify + Demo mode (no social login for now)

import React, { useState } from 'react';
import { useAmplifyAuth } from '../../contexts/AmplifyAuthProvider';

const EnhancedLoginPage = () => {
  const { login, error, setError, demoUsers, loading } = useAmplifyAuth();
...
const SignupPage = ({ onBackToLogin }) => {
  const { signup, error, setError } = useAmplifyAuth();
